...
const AvantaBanner = () => {
  return (
    <div className="w-full bg-[#A30B43] flex flex-col md:flex-row    overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center -mt-3 items-center text-white  px-6 text-center">
        ...
        <h1 className="text-2xl md:text-4xl font-cinzel font-semibold lg:text-4xl tracking-wide leading-tight uppercase">
