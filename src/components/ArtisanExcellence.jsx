...
const ArtisanExcellence = () => {
  ...
  return (
    <section className="bg-white py-12 pl-6 md:pl-16 font-serif">
      {/* Top Section: Text and Image Grid */}
      <div className="max-w-[90rem]  ml-auto grid grid-cols-1 lg:grid-cols-2 gap-7 items-center">
        ...
        <div className="space-y-6 ">
          ...
          <div className="text-gray-700 text-sm md:text-base leading-relaxed space-y-4 px-2">
            <p>
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="grid grid-cols-2">
             ...
             <img src="/images/manufacuring/image-24.svg" alt="work" className="w-full h-24 md:h-32 object-cover" />
          </div>
        </div>
      </div>
