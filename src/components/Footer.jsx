...
export default function Footer() {
  const shopLinks = [
    { name: "Suits Set", href: "/shop/suits-set" },
    { name: "Kurti Set", href: "/shop/kurti-set" },
    { name: "Anarkali Set", href: "/shop/anarkali-set" },
    { name: "Top & Tunics Set", href: "/shop/top-tunics" },
    { name: "Gown", href: "/shop/gown" },
    { name: "Co-ord Set", href: "/shop/co-ord-set" },
  ];

  const aboutLinks = [
    { name: "About Us", href: "/about" },
    { name: "Crafted Heritage", href: "/crafted-heritage" },
    { name: "Designed For Resellers", href: "/resellers" },
    { name: "Founder Messages", href: "/founder-messages" },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-5">
          ...
          <div className="lg:pl-8">
            ...
            <ul className="text-xs space-y-3 text-black">
              {shopLinks.map((link) => (
                <li key={link.name} className="hover:translate-x-1 transition-transform cursor-pointer">
          ...
          {/* Follow Us */}
          <div>
            <h3 className="font-bold text-[13px] uppercase tracking-wider mb-5">Follow Us</h3>
            <div className="space-y-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-5">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 w-full md:w-auto">
            ...
            <button className="bg-[#1e1b3a] text-white rounded-full px-8 py-4 rounded text-[11px] font-bold uppercase tracking-[0.15em] hover:bg-black transition-all shadow-lg whitespace-nowrap">
              Download Catalog +
            </button>
          </div>
        </div>
