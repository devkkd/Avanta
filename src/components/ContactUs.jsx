      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="w-full lg:w-1/3">
          <div className="flex items-center justify-start gap-2 mb-2">
            ...
            <h3 className="text-[10px] md:text-xs font-bold text-[#1a1a3d] uppercase tracking-widest">
              Avanta by Jaipur Kurti Gharana
            </h3>
            <span className="h-1.5 w-1.5 bg-[#DE3163] rounded-full"></span>
          </div>

          <h1 className="text-2xl md:text-3xl font-cinzel font-bold mb-6 text-black">
            Contact Us
          </h1>
