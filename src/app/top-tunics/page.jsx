...
const products = [
  { id: 1, tag: 'NEW', title: 'Premium Tops & Tunics', price: '₹599 to ₹1299', img: 'https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?q=80&w=500' },
  { id: 2, tag: 'NEW', title: 'Designer Tops', price: '₹699 to ₹1399', img: 'https://images.unsplash.com/photo-1617137968427-85924c800a22?q=80&w=500' },
  { id: 3, tag: null, title: 'Casual Tunics', price: '₹499 to ₹999', img: 'https://images.unsplash.com/photo-1612336307429-8a898d10e223?q=80&w=500' },
  { id: 4, tag: null, title: 'Formal Tops', price: '₹799 to ₹1499', img: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=500' },
  { id: 5, tag: null, title: 'Embroidered Tunics', price: '₹899 to ₹1599', img: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?q=80&w=500' },
  { id: 6, tag: null, title: 'Modern Tops', price: '₹599 to ₹1199', img: 'https://images.unsplash.com/photo-1589156229687-496a31ad1d1f?q=80&w=500' },
  { id: 7, tag: null, title: 'Ethnic Tunics', price: '₹749 to ₹1349', img: 'https://images.unsplash.com/photo-1564485377539-4af72d1f6a2f?q=80&w=500' },
  { id: 8, tag: 'NEW', title: 'Printed Tops', price: '₹649 to ₹1249', img: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?q=80&w=500' },
];
    ...
    <div>
      <div className="max-w-[1440px] mx-auto px-4 md:px-12 py-10 bg-white font-sans">
        ...
        <div className="text-center mb-10">
          <p className="text-sm font-semibold tracking-widest uppercase mb-1">Casual Collection</p>
          <h1 className="text-3xl md:text-4xl font-serif font-bold tracking-tight text-gray-900 uppercase">
            Tops & Tunics
          </h1>
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Discover our versatile collection of stylish tops and tunics, perfect for everyday wear and special occasions.
          </p>
        </div>
              ...
              <div className={`${viewMode === 'list' ? 'flex-1' : ''}`}>
                <div className="space-y-2">
                  ...
                  <p className="text-[11px] text-gray-500 leading-relaxed">
                    Stylish and comfortable tops and tunics perfect for everyday wear.
                    {viewMode === 'list' && ' Modern designs combined with traditional elements, ideal for casual outings and work.'}
                  </p>
                  ...
                  {viewMode === 'list' && (
                    <div className="mt-4 text-xs text-gray-600">
                      <div className="flex gap-4">
                        <span>Material: 100% Cotton/Linen</span>
