...
const products = [
  { id: 1, tag: 'NEW', title: 'Stylish Co-Ord Set', price: '₹799 to ₹1699', img: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=500' },
  { id: 2, tag: 'NEW', title: 'Designer Co-Ord', price: '₹999 to ₹1999', img: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?q=80&w=500' },
  { id: 3, tag: null, title: 'Casual Co-Ord Set', price: '₹699 to ₹1499', img: 'https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?q=80&w=500' },
  { id: 4, tag: null, title: 'Party Co-Ord', price: '₹899 to ₹1799', img: 'https://images.unsplash.com/photo-1617137968427-85924c800a22?q=80&w=500' },
  { id: 5, tag: null, title: 'Premium Co-Ord Set', price: '₹1199 to ₹2199', img: 'https://images.unsplash.com/photo-1612336307429-8a898d10e223?q=80&w=500' },
  { id: 6, tag: null, title: 'Modern Co-Ord', price: '₹849 to ₹1749', img: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=500' },
  { id: 7, tag: null, title: 'Printed Co-Ord Set', price: '₹749 to ₹1599', img: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?q=80&w=500' },
  { id: 8, tag: 'NEW', title: 'Elegant Co-Ord', price: '₹999 to ₹1899', img: 'https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?q=80&w=500' },
];
    ...
    <div>
      <div className="max-w-[1440px] mx-auto px-4 md:px-12 py-10 bg-white font-sans">
        ...
        <div className="text-center mb-10">
          <p className="text-sm font-semibold tracking-widest uppercase mb-1">Fashionable Sets</p>
          <h1 className="text-3xl md:text-4xl font-serif font-bold tracking-tight text-gray-900 uppercase">
            Co-Ord Sets
          </h1>
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Discover our trendy co-ord sets, the perfect combination of style and comfort for modern fashion enthusiasts.
          </p>
        </div>
              ...
              <div className={`${viewMode === 'list' ? 'flex-1' : ''}`}>
                <div className="space-y-2">
                  ...
                  <p className="text-[11px] text-gray-500 leading-relaxed">
                    Contemporary co-ord sets featuring perfectly matched top and bottom combinations.
                    {viewMode === 'list' && ' Ideal for casual hangouts, office wear, and social gatherings with versatile styling options.'}
                  </p>
                  ...
                  {viewMode === 'list' && (
                    <div className="mt-4 text-xs text-gray-600">
                      <div className="flex gap-4">
                        <span>Material: Rayon/Cotton Blend</span>
