...
export default function BulkUploadPage() {
  ...
  const downloadTemplate = () => {
    const csvContent = `name,description,categorySlug,subcategorySlug,priceMin,priceMax,mainImage,galleryImages,sizes,material,productCare,additionalInfo,colorName,colorCode,styleCode,sku,slug,isActive,isFeatured,isNew,tags,sortOrder
